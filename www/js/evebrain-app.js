...
EveBrainApp.prototype.setConnState = function(){
  ...
  switch(this.connState){
    case 'not_set':
      cs.innerHTML = '&#10007; Not Connected  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <object data="img/ConnectIcon.svg" style="fill:red;" type="image/svg+xml"></object>&nbsp;&nbsp;<a href="#">Connect</a>&nbsp;&nbsp;';
      cs.querySelector('a').addEventListener('click', function(e){ self.configure(e) });
      cs.className = 'connState';
      break;
    case 'connected':
      cs.innerHTML = '&#10003; Connected  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="img/RefreshIcon.svg">&nbsp;&nbsp;<a href="#">Refresh</a>&nbsp;&nbsp;';
      cs.querySelector('a').addEventListener('click', function(e){ self.configure(e) });
      cs.className = 'connState connected';
      break;
    case 'cant_connect':
      cs.innerHTML = '&#10007; Can\'t Connect   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="img/RefreshIcon.svg">&nbsp;&nbsp;<a href="#">Refresh<a>&nbsp;&nbsp;';
      cs.querySelector('a').addEventListener('click', function(e){ self.configure(e) });
      cs.className = 'connState error';
      break;
    case 'disconnected':
      cs.innerHTML = '&#10007; Not Connected  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="img/RefreshIcon.svg">&nbsp;&nbsp;<a href="#">Refresh</a>&nbsp;&nbsp;';
      cs.querySelector('a').addEventListener('click', function(e){ self.configure(e) });
      cs.className = 'connState error';
      break;
    default:
      cs.innerHTML = '&#10007; Not Connected  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="img/ConnectIcon.svg">&nbsp;&nbsp;<a href="#">Connect</a>&nbsp;&nbsp;';
      cs.querySelector('a').addEventListener('click', function(e){ self.configure(e) });
      cs.className = 'connState';
      break;
